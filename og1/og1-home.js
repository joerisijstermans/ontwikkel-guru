...
.og1-nav-cta:hover { background: #4a3de0 !important; }
...
`;
  ...
  class Og1Home extends HTMLElement {
    connectedCallback() {
      ...
      this.innerHTML = `
        <!-- NAV -->
        <nav class="og1-nav og1-nav-transparent" id="og1-nav">
          <div class="og1-nav-inner">
            ...
            <button class="og1-nav-hamburger" id="og1-hamburger" aria-label="Menu">
              <span></span><span></span><span></span>
            </button>
          </div>
        </nav>
        <div class="og1-nav-mobile" id="og1-mobile-menu">
          <a href="#">Home</a>
          <a href="#">Portfolio</a>
          <a href="#">Aanbod</a>
          <a href="#">Over ons</a>
          ...
          <div class="og1-container">
            <div class="og1-footer-inner">
              <div class="og1-footer-top">
                <div>
                  <span style="font-size:1rem;font-weight:800;color:white;letter-spacing:-0.01em;">Ontwikkel Guru</span>
                  <p class="og1-footer-tagline">AI die werkt voor mensen.<br>Praktisch, concreet en toepasbaar voor het MKB.</p>
                </div>
                <div>
    ...
    _setup() {
      ...
      // Scroll nav
      const nav = this.querySelector('#og1-nav');
      const onScroll = () => {
      ...
      // Hamburger
      const hamburger = this.querySelector('#og1-hamburger');
      const mobileMenu = this.querySelector('#og1-mobile-menu');
