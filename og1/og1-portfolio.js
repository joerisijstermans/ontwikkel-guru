...
.og1p-modal-inner { position: relative; }
.og1p-modal-inner video { display: block; border-radius: 12px; max-width: min(90vw, 960px); max-height: 80vh; width: auto; height: auto; min-width: 280px; }
...
`;
  ...
  const VIDEOS = [
    { id:1,
      ...
      description:'Cinematic merkvideo die in 15 seconden de missie van een duurzaam food-merk vertelt, puur op beeld en muziek, zonder voice-over. Zo positioneer je je merk als geloofwaardig en onderscheidend, zonder filmcrew of duur productiebudget.',
    ...
    { id:2,
      ...
      brand:'Lumion Beauty', category:'product', aspect:'9:16', demo:true,
      description:'Sfeervolle productvideo voor een luxe skincare lijn, gemaakt zonder studio of filmploeg en klaar in 18 seconden. Perfect als website-hero, social ad of productlancering die meteen vertrouwen wekt en klikt.',
    ...
    { id:3,
      ...
      brand:'Lumion Beauty', category:'product', aspect:'9:16', demo:true,
      description:'Lifestyle video die de beleving verkoopt in plaats van het product: emotie en verlangen in 20 seconden. Ideaal als Instagram-campagne of aanvulling op een productpagina die converteert en bijblijft.',
    ...
    { id:4,
      ...
      description:'Social reel die een B2B-softwareproduct in 18 seconden menselijk en herkenbaar maakt voor precies de doelgroep die je wil bereiken. Inzetbaar als LinkedIn-ad, website-header of campagnevideo die engagement en klikken genereert.',
    ...
    { id:5,
      ...
      description:'Dynamische reel die de markt-sfeer van een food-merk authentiek vastlegt in 18 seconden, snel te produceren en goed deelbaar. Toepasbaar als TikTok-campagne, Reels-ad of organische content die het algoritme beloont.',
    ...
    { id:6,
      ...
      brand:'Lumion Beauty', category:'campagne', aspect:'9:16', demo:true,
      description:'Eerste clip van een tweedelige seizoenscampagne die merkherkenning opbouwt door herhaling en visuele consistentie. Ideaal voor merken die zichtbaar en herkenbaar willen blijven door de hele campagneperiode heen.',
    ...
    { id:7,
      ...
      brand:'Lumion Beauty', category:'campagne', aspect:'9:16', demo:true,
      description:'Tweede clip van de zomercampagne, zelfde visuele taal maar een frisse invalshoek die de reeks verlengt. Een videoreeks werkt als serie: elke post versterkt de vorige en bouwt aan je merkimago.',
    ...
    { id:8,
      ...
      description:'Professionele kantoor-b-roll die je merk direct geloofwaardig en aantrekkelijk maakt in presentaties, pitch decks of video-advertenties. Een professioneel eindresultaat in 18 seconden, zonder duur filmteam.',
    ...
    { id:9,
      ...
      brand:'Nexora', category:'corporate', aspect:'9:16', demo:true,
      description:'B-roll over samenwerking en teamdynamiek, universeel inzetbaar bij thought leadership content of employer branding campagnes. Toont hoe je in 18 seconden een sterk werkgeversimago neerzet dat talent aantrekt.',
    ...
    { id:10,
      ...
      brand:'Ontwikkel Guru', category:'avatar', aspect:'9:16', demo:false,
      description:'Joeri Sijstermans als AI-avatar: één opname, oneindig veel gepersonaliseerde versies op naam van de ontvanger. Verhoogt openingsratio\'s en reacties op outreach aanzienlijk, voor een fractie van de kosten van traditionele video.',
    ...
    { id:11,
      ...
      brand:'Nexora', category:'onboarding', aspect:'9:16', demo:true,
      description:'AI-avatar Emma verwelkomt elke nieuwe medewerker met een warme, consistente onboarding, schaalbaar naar elke afdeling of locatie. Bespaart HR-uren en geeft elk nieuw teamlid direct het gevoel dat ze echt welkom zijn.',
    ...
    { id:12,
      ...
      brand:'Verdant Group', category:'onboarding', aspect:'9:16', demo:true,
      description:'Volledige AI-workshop van ruim 3 minuten gegeven door een AI-avatartrainer, met dezelfde kwaliteit en consistentie bij elk team en op elke locatie. Schaal je kennisdeling zonder extra trainingskosten of roosteruitdagingen.',
    ...
    { id:13,
      ...
      brand:'BusinessBaas', category:'onboarding', aspect:'9:16', demo:false,
      description:'AI-avatar Bodhi leidt nieuwe platformleden in 6 minuten door de eerste stappen, vermindert drop-off en geeft elk lid een persoonlijk welkom op schaal. Eén keer produceren, duizend keer inzetten: de definitie van schaalbare onboarding.',
    ...
    { id:14,
      ...
      brand:'BusinessBaas', category:'coaching', aspect:'16:9', demo:false,
      description:'Nova is de AI business coach van BusinessBaas, en deze introductievideo laat zien hoe een persoonlijke coaching-relatie via video-avatar eruitziet. Toegankelijk, herkenbaar en altijd beschikbaar voor elk lid, 24 uur per dag.',
    ...
    { id:15,
      ...
      brand:'BusinessBaas', category:'aankondiging', aspect:'16:9', demo:false,
      description:'Aankondigingsvideo voor een strategische samenwerking, inzetbaar als social post of e-mailcampagne. Zo breng je een partnership in 30 seconden krachtig en professioneel naar buiten, zonder productiedagen.',
    ...
    { id:16,
      ...
      brand:'Forchetta', category:'campagne', aspect:'9:16', demo:true,
      description:'Cinematic 8-seconden shot van een chef die verse kruiden op een gerecht legt, krachtig openingsmateriaal voor een menufilm, website-hero of Instagram-ad. Gemaakt zonder filmcrew, in de stijl van een high-end restaurant.',
    ...
    { id:17,
      ...
      brand:'Nexora', category:'corporate', aspect:'16:9', demo:true,
      description:'6-seconden reel van een bruisende kantoortuin, direct inzetbaar als employer branding content op LinkedIn of Instagram. Authentiek beeldmateriaal dat talent aantrekt en je werkgeversmerk versterkt, gemaakt zonder filmploeg.',
    ...
    { id:18,
      ...
      description:'Spelers die opwarmen in een voetbalstadion: de spanning van de laatste minuten vóór de wedstrijd vastgelegd in 20 seconden. Perfect voor sportcampagnes, ticketing of sponsoractivaties die emotie en energie uitstralen.',
    ...
    { id:19,
      ...
      brand:'ProSport', category:'campagne', aspect:'16:9', demo:true,
      description:'Cinematische rondgang door een leeg voetbalstadion, grandioze architectuur en stille spanning in 20 seconden. Krachtig openingsshot voor een sponsorfilm, eventaankondiging of merkfilm die indruk moet maken.',
