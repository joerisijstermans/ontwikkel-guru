...
`;
  ...
  const VIDEOS = [
    ...
    { id:12,
      ...
      description:'AI-avatar als workshoptrainer. Ideaal voor bedrijven die een kennissessie willen schalen naar meerdere teams of locaties, met dezelfde kwaliteit elke keer.',
    ...
    { id:15,
      ...
      description:'Verticale aankondigingsvideo voor een strategische samenwerking. Inzetbaar als social post of e-mailcampagne om een partnership krachtig en snel naar buiten te brengen.',
